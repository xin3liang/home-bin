...
block_size=512
RPC=/usr/libexec/spdk/scripts/rpc.py && \$RPC --help > /dev/null 2>&1 || RPC=/root/spdktest/spdk/scripts/rpc.py
BDEVPERF=/usr/libexec/spdk/scripts/bdevperf.py && \$BDEVPERF --help > /dev/null 2>&1 || BDEVPERF=/root/spdktest/spdk/examples/bdev/bdevperf/bdevperf.py
