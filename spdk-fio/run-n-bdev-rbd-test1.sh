...
max_rbd_num=100
block_size=512
RPC=/root/spdktest/spdk/scripts/rpc.py  && $RPC --help > /dev/null 2>&1 || RPC=/root/work/spdk/scripts/rpc.py  && $RPC --help > /dev/null 2>&1 || RPC=/usr/libexec/spdk/scripts/rpc.py && $RPC --help > /dev/null 
BDEVPERF=/root/spdktest/spdk/examples/bdev/bdevperf/bdevperf.py && $BDEVPERF --help > /dev/null  2>&1 || BDEVPERF=/root/work/spdk/examples/bdev/bdevperf/bdevperf.py && $BDEVPERF --help > /dev/null 2>&1 || BDEVPERF=/usr/libexec/spdk/scripts/bdevperf.py && $BDEVPERF --help > /dev/null
